...
by passing the same `session_id` into the SDK again. To permanently terminate your session, see [Terminate Session](https://docs.diarupt.ai/api-reference/session/post-terminate-session)
</Warning>
