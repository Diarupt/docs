...
Behaviours are a core part of an Interaction as they set the ground rules for how the AI will respond and interact with the user. Currently, there are a few predefined behaviours to which more would be added.
